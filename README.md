...
###### <p id="code-1" align="right">examples/basic/compose-no-export.js • <a href="examples/basic/compose-no-export.js">View source</a></p>
```js
...
###### <p id="code-2" align="right">examples/basic/modules.js • <a href="examples/basic/modules.js">View source</a></p>
```js
export default {
    components: {
...
###### <p id="code-3" align="right">examples/basic/compose.js • <a href="examples/basic/compose.js">View source</a></p>
```js
import composer from 'module-composer';
import modules from './modules';
...
###### <p id="code-4" align="right">examples/basic/app.js • <a href="examples/basic/app.js">View source</a></p>
```js
...
###### <p id="code-5" align="right">examples/basic/modules/index.js • <a href="examples/basic/modules/index.js">View source</a></p>
```js
...
###### <p id="code-6" align="right">examples/basic/modules/components/index.js • <a href="examples/basic/modules/components/index.js">View source</a></p>
```js
...
###### <p id="code-7" align="right">examples/basic/compose-mermaid.js • <a href="examples/basic/compose-mermaid.js">View source</a></p>
```js
import composer from 'module-composer';
import modules from './modules';
...
###### <p id="code-13" align="right">examples/gravatar-spa/src/compose.js • <a href="examples/gravatar-spa/src/compose.js">View source</a></p>
```js
import composer from 'module-composer';
import modules from './modules';
